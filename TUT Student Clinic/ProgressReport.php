...
{
    if(isset($_POST['returnCondition'],$_POST['patientName'],$_POST['cComplaint'],$_POST['medPrescription']) && !empty($_POST['returnCondition']) && !empty($_POST['patientName']) && !empty($_POST['cComplaint']) && !empty($_POST['medPrescription']))
    {
        $returnCondition = trim($_POST['returnCondition']);
        $patientName = trim($_POST['patientName']);
        $CurrentComplaints = trim($_POST['cComplaint']);
        $medPrescription = trim($_POST['medPrescription']);
			...
			$returnDate = 'No Return';
				...
				//$today = date("Y-m-d") ;
				 $sql = "UPDATE tbladulttriangleform SET returnCondition=:returnCondition, CurrentComplaints=:CurrentComplaints, medPrescription=:medPrescription,  returnDate=:returnDate  WHERE CurrentComplaints = '$CurrentComplaints'";
            ...
            <div class="sidebar-inner slimscroll">
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li class="active">
                            <a href="ProgressNote.php"><i class="fa fa-hospital-o"></i> <span>Medical Prescription</span></a>
                        </li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Progress Report</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <div class="row">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<select name="returnCondition" class="select">
											<option>Select</option>
											<option>Discharged No return</option>
											<option>Discharged with Return</option>
								 ...
								 <div class="col-md-6">
									<div class="form-group">
										<label>Patiant Name</label>
										<select name="patientName" class="select">
										<option>Select</option>
										<?php $stmt = $pdo->query("SELECT name, surname FROM tbladulttriangleform");
								 ...
								 <div class="col-md-6">
									<div class="form-group">
										<label>Current Complaint</label>
										<select name="cComplaint" class="select">
										<option>Select</option>
							   ...
							   <div class="col-sm-12">
								   <div class="form-group">
										...
										<textarea name="medPrescription" cols="30" rows="4" class="form-control"></textarea>
									</div>
								</div>
