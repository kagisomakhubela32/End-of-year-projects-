                        ...
                        <div class="col-md-12">
                            <div class="profile-view">
                                ...
                                <div class="profile-basic">
                                    <div class="row">
									<?php
											$stmt = $pdo->query("SELECT * FROM tbluser where name = '$namePrifile' and surname = '$surnamePrifile'");
                                        ...
                                        <div class="col-md-5">
                                            <div class="profile-info-left">
                                                <h3 class="user-name m-t-0 mb-0"><?php echo $row['name']." ".$row['surname'];?></h3>
                                                <small class="text-muted"><?php echo $row['specialasation']?></small>
                                        ...
                                        <div class="col-md-7">
                                            <ul class="personal-info">
                                                <li>
                                                    ...
                                                    <span class="text"><a href="#"><?php echo $row['cellphone']?></a></span>
                                                </li>
                                                <li>
                                                ...
                                                <li>
													...
													$day = substr($s, 4,2);
													?>
                                                    <span class="text"><?php echo $x.$year."/".$month."/".$day?></span>
                                                </li>
                                                <li>
