                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								...
								<li class="active"><a href="doctor.php">View Doctors</a></li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-doc.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Doctor</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
							...
							<table class="table table-border table-striped custom-table datatable mb-0">
								...
								<tbody>
									...
									while ($row = $stmt->fetch()) {
										?>
									<tr>
										<td><?php  echo $row['name'].$space.$row['surname']?></td>
										<td><?php  echo $row['dob']?></td>
										<td><?php  echo $row['address'].",".$row['pcode']?></td>
										<td><?php  echo $row['cellphone']?></td>
										<td><?php  echo $row['altNumber'].$space.$row['surname']?></td>
										<td><?php  echo $row['email'].$space.$row['surname']?></td>
										<td class="text-right">
