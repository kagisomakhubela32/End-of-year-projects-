...
if(isset($_POST['submit']))
{
    if(isset($_POST['department'],$_POST['doctor'],$_POST['date'],$_POST['time']) && !empty($_POST['department']) && !empty($_POST['doctor']) && !empty($_POST['date']) && !empty($_POST['time']))
    {
		...
		$id = $_GET['update'];
               ...
               mysql_query("update client set department = '$department', doctor = '$doctor', date ='$date', time ='$time',cellphone ='$cellphone', message ='$message', patientName ='$patientName', sickness = '$sickness' appointmentID='$id'");
                    ...
                    <div class="col-lg-8 offset-lg-2">
						...
						if (isset($_GET['update'])) {
							$id = $_GET['update'];
								...
								$stmt = $pdo->query("SELECT * FROM tblappointment where appointmentID = '$id'");
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
										...
										<input name="appointmentID" class="form-control" type="text"  value="<?php  echo $row['appointmentID']?>">
									</div>
                                </div>
                                  <div class="col-md-6">
                                    <div class="form-group">
										<label>Patient Name</label>
										<input name="patientName" class="form-control" type="text" value="<?php  echo $row['patientName']?>">
									</div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Date</label>
                                        <div class="cal-icon">
                                            <input name="date" type="today" class="form-control datetimepicker" value="<?php echo $row['date']?>">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Time</label>
                                        <div class="time-icon">
                                            <input name="time" type="text" class="form-control" id="datetimepicker3" value="<?php echo $row['time']?>">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Sickeness</label>
                                        <input name="sickness" class="form-control" type="text" value="<?php  echo $row['sickness']?>">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Patient Phone Number</label>
                                        <input name="cellphone" class="form-control" type="text" value="<?php  echo $row['cellphone']?>">
                                    </div>
                                </div>
                            </div>
							   <div class="row">
                            ...
                            <div class="form-group">
                                <label>Message</label>
                                <textarea name="message" cols="30" rows="4" class="form-control" value="<?php echo $row['message']?>"></textarea>
                            </div>
								<?php }?>
                            <div class="m-t-20 text-center">
                                 <button type="submit" name="submit" class="btn btn-primary submit-btn">Update Appointment</button>
                            </div>
                        </form>
                    </div>
                </div>
