					...
					<div class="col-md-12">
						<div class="table-responsive">
							<table class="table table-striped custom-table">
								...
								<tbody>
									<?php
								$stmt = $pdo->query("SELECT * FROM tblappointment");
								...
								?>
									<tr>
										...
										<td><span class="custom-badge status-green"><a href="AdultTriangleForm.php">Take Up</a></span></td>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													...
													<a class="dropdown-item" href="action.php?remove=<?= $row['appointmentID'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
										<?php }?>
