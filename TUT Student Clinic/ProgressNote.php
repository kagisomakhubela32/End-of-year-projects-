...
{
    if(isset($_POST['investigationResult'],$_POST['progressName'],$_POST['time'],$_POST['date']) && !empty($_POST['investigationResult']) && !empty($_POST['progressName']) && !empty($_POST['time']) && !empty($_POST['date']))
    {
        $ward = trim($_POST['ward']);
        $patientName = trim($_POST['patientName']);
        $date = trim($_POST['date']);
        $time = trim($_POST['time']);
		$progressName = trim($_POST['progressName']);
		$CurrentComplaints = trim($_POST['sick']);
        $investigationResult = trim($_POST['investigationResult']);
				...
				//$today = date("Y-m-d") ;
				 $sql = "UPDATE tbladulttriangleform SET ward=:ward, patientName=:patientName, date=:date, CurrentComplaints=:CurrentComplaints, time=:time, progressName=:progressName, investigationResult=:investigationResult WHERE date like '$date%' and CurrentComplaints = '$CurrentComplaints'";
                    ...
                    <ul>
						...
						<li class="submenu">
							...
							<ul style="display: none;">
								<li><a href="add-doc.php.php">Add Doctor</a></li>
            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Progress Note</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
					...
					<form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
                            <div class="row">
                                ...
                                <div class="col-md-6">
									<div class="form-group">
										<label>Petiant Name</label>
										<select name="patientName" class="select">
										<option>Select</option>
										<?php $stmt = $pdo->query("SELECT * FROM tbladulttriangleform");
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<?php $stmt = $pdo->query("SELECT * FROM tbladulttriangleform");
											...
											<option><?php  echo $row['CurrentComplaints']?></option>
											<?php
											}?>
										</select>
									</div>
								...
								<div class="col-sm-12">
								   <div class="form-group">
										...
										<textarea name="progressName" cols="30" rows="4" class="form-control"></textarea>
									</div>
								</div>
								<div class="col-sm-12">
								   <div class="form-group">
										<label>Investigation and Result</label>
										<textarea name="investigationResult" cols="30" rows="4" class="form-control"></textarea>
									</div>
								</div>
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" name="submit"  class="btn btn-primary submit-btn">Progress Note</button>
                            </div>
                        </form>
                    </div>
                </div>
