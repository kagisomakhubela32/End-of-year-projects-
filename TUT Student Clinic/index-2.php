                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3>50</h3>
                                <span class="widget-title2"> Admitted Patients <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-6 col-xl-3">
                        <div class="dash-widget">
                            ...
                            <div class="dash-widget-info text-right">
                                <h3>618</h3>
                                <span class="widget-title4">Casualty  <i class="fa fa-check" aria-hidden="true"></i></span>
                            </div>
                        </div>
                    </div>
                </div>
								...
								<div class="table-responsive">
									<table class="table mb-0">
										...
										<tbody>
											<?php
											$today = date("d/m/20y") ;
											$stmt = $pdo->query("SELECT * FROM tblappointment where date = '$today'");
											...
											<tr>
												<td style="min-width: 200px;">
													...
													<h2><a href="profile.html"><?php  echo $row['patientName']?> <span>Durban, SA</span></a></h2>
												</td>                 
												<td>
												...
												<td class="text-right">
													<a href="AdultTriangleForm.php" class="btn btn-outline-primary take-btn">Take up</a>
												</td>
											</tr><?php }?>
								...
								<div class="table-responsive">
									<table class="table mb-0 new-patient-table">
										<tbody>
											...
											$stmt = $pdo->query("SELECT * FROM tbladulttriangleform where Date like '$today%'");
											while ($row = $stmt->fetch()) {
												?>
											...
											<tr>
												<td>
													...
													<h2><?php  echo $row['Name'].$space.$row['surname']?></h2>
												</td>
												<td><?php  echo $row['Pulse']?></td>
												<td><?php  echo $row['BP']?></td>
												<td><button class="btn btn-primary btn-primary-one float-right"><?php  echo $row['CurrentComplaints']?></button></td>
											</tr>
											<?php }?>
										</tbody>
									</table>
