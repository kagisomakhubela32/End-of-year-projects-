...
if(isset($_POST['submit']))
{
   // if(isset($_POST['oPassword'],$_POST['nPassword'],$_POST['cPassword']){
		...
		/*$sql = "UPDATE tblupdatereg SET date=?, present=? WHERE email=?";
		$stmt= $pdo->prepare($sql);
		$stmt->execute([$email, $date, $present]);*/
		$data = [
            ...
            <ul class="nav user-menu float-right">
                ...
                <li class="nav-item dropdown has-arrow">
                    <a href="#" class="dropdown-toggle nav-link user-link" data-toggle="dropdown">
                       ...
                       <?php $profileName = $_SESSION["email"];?>                      
                        ...
                        <form action="UpdatePassword.php" method="post">
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input name="oPassword" type="password" class="form-control">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center m-t-20">
                                    <button  href="UpdatePassword.php?remove=<?= $row['email'] ?>"  type="submit" name="submit"  type="button" class="btn btn-primary submit-btn">Update Password</button>
                                </div>
                            </div>
                        </form>
                    </div>
