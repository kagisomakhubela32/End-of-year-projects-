                ...
                <div id="sidebar-menu" class="sidebar-menu">
                    <ul>
						...
						<li>
						 ...
						 <li>
                            <a href="forgot-password.php"><i class="fa fa-key"></i> <span>Forgot Password</span></a>
                        </li>
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="add-appointmentP.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Appointment</a>
                    </div>
                </div>
				<div class="row">
					<div class="col-md-12">
									...
									<tr>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												...
												<div class="dropdown-menu dropdown-menu-right">
													<a class="dropdown-item" href="edit-appointment.php?update=<?= $row['appointmentID'] ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
													<a class="dropdown-item" href="actionP.php?remove=<?= $row['appointmentID'] ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
										<?php }?>
